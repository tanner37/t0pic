...
```text
$ git clone https://github.com/tanner37/t0pic.git
$ cd t0pic
...
Pastebin: [txt.t0.vc](https://txt.t0.vc) - [Source Code](https://github.com/tanner37/t0txt)

Short URL: [url.t0.vc](https://url.t0.vc) - [Source Code](https://github.com/tanner37/t0url)
